...
tileset.readyPromise
  ...
  SELECT t1.globalid AS gid_1,
     t2.globalid AS gid_2,
     t1.basename,
     st_3dintersection(t1.geom, t2.geom) AS intgeom
    FROM "LA_LSBU" t1
      CROSS JOIN "LA_LSBU" t2
   WHERE t1.globalid::text <> t2.globalid::text AND t1.basename::text = t2.basename::text AND geometrytype(t1.geom) IS NOT NULL AND geometrytype(t2.geom) IS NOT NULL AND t1.basename::text = '15-371 OA_Westflank 3BC_23-01-2019_Revspace'::text AND t2.basename::text = '15-371 OA_Westflank 3BC_23-01-2019_Revspace'::text
  LIMIT 10000;
